...
public class LocationsTests {
	...
	public void setup() throws Exception {
		...
		Util.login(driver);
		driver.findElement(By.id("locsLink")).click();
	}
	...
	public void imgActive() throws Exception {
		...
		Util.takeSnapShot(driver, Util.SCREENSHOTS_LOCATION + "\\locs-active-img.png");

		assertTrue(src.contains("images/locations-icon.png"));
	}
	...
	public void addMaterialButton() {
		...
		String expectedTitle = Util.EXPECTED_NEW_LOCS_TITLE;
